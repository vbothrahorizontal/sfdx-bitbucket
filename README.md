...
9) Set up Bitbucket Pipelines [environment variable](https://Bitbucket.com/help/ci/variables/README#variables) The `key` and `iv` used to encrypt your `server.key` file.
